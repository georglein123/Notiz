...
- **分析模型**
  ...
  - 点击`修复`——修复向导——诊断——更新，即可查看当前零件的三角形面片情况，有问题的三角形面片在模型中红色显示
    - 坏边：模型正反面交叉
    - 孔洞：模型是破的，需要补洞
    - 重叠/交叉三角形面片不影响打印
...
- **查看零件尺寸**：在“分析&报告”选项中，选择“零件尺寸”，即可查看零件尺寸
...
- **缩放模型**
  - 选择“工具”——“缩放”
    - 若选中“统一缩放”，表示对零件整个维度一起缩放
    - 若只是缩放某个维度，比如Z轴拉高，则取消选中“统一缩放”，并对需要的维度改变对应尺寸
...
打印效率：和Z轴摆放姿态，层厚，以及打印工艺有关（如DLP和SLA效率就不一样）
