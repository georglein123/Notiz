chairside 自动均匀性校准新流程及复检界面使用V3.0
...
​	3.5 然后命令行输入`sudo reboot`，重启打印机并再次复核文件删除成功
...
![image-20220715094215116](E:\文档\GitHub\Notiz\chairside 自动均匀性校准新流程及复检界面使用V3.0.assets\image-20220715094215116.png)
